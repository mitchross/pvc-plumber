...
> Before bumping from any `1.x` tag, read `MIGRATION-v1-to-v2.md` (in git history — archive pruned 2026-06-13).
...
- **`SYSTEM_NAMESPACES` env var (CSV, additive).** Always seeded with the
  ...
  replace. See v3 spec § 3.4 (in git history — archive pruned 2026-06-13).
